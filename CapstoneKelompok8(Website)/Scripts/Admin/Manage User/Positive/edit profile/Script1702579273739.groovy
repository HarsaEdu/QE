...
WebUI.setText(findTestObject('Admin/Manage User/edit nama depan'), '')

WebUI.setText(findTestObject('Admin/Manage User/edit nama depan'), 'aku ganteng banget')

WebUI.click(findTestObject('Admin/Manage User/button simpan edit'))

WebUI.click(findTestObject('Admin/Manage User/confirm simpan'))
...
WebUI.setText(findTestObject('Admin/Manage User/search'), 'aku ganteng banget')
