...
WebUI.setText(findTestObject('Admin/Manage User/edit password'), 'hello123')

WebUI.setText(findTestObject('Admin/Manage User/edit konfirmasi password'), 'hello')

WebUI.click(findTestObject('Admin/Manage User/button edit akun'))

WebUI.getText(findTestObject('Admin/Manage User/message confirm passsword tidak sesuai dengan password'))
