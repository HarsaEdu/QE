...
WebUI.setText(findTestObject('Admin/Manage User/edit email'), 'ujicobaeditgmail.com')

WebUI.click(findTestObject('Admin/Manage User/button edit akun'))

WebUI.getText(findTestObject('Admin/Manage User/message format email salah'))
