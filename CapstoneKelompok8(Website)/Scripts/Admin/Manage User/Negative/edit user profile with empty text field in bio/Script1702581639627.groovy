...
WebUI.sendKeys(findTestObject('Admin/Manage User/edit bio'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Admin/Manage User/edit bio'), Keys.chord(Keys.BACK_SPACE))

WebUI.click(findTestObject('Admin/Manage User/button simpan edit'))

WebUI.getText(findTestObject('Admin/Manage User/message bio'))
