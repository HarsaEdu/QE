...
WebUI.click(findTestObject('Admin/ulasan/ulasan'))

WebUI.click(findTestObject('Admin/ulasan/delete'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Admin/ulasan/yes delete'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot()

WebUI.getText(findTestObject('Admin/ulasan/succes'))
